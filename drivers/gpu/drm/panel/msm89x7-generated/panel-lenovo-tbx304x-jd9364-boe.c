...
{
	return container_of_const(panel, struct jd9364_boe, panel);
}
...
static int jd9364_boe_on(struct jd9364_boe *ctx)
{
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x01, 0x6f);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x04, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x05, 0x1f);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x0a, 0x1e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x0b, 0x1e);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x1a, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x1b, 0x1f);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x21, 0x1e);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_WRITE_MEMORY_START,
				     0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_WRITE_LUT, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_READ_MEMORY_START,
				     0x40);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x2f, 0x40);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_SET_PARTIAL_ROWS, 0x1f);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x37, 0x1e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x38, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x39, 0x48);
	mipi_dsi_dcs_set_pixel_format_multi(&dsi_ctx, 0x48);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x3b, 0x4a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_WRITE_MEMORY_CONTINUE,
				     0x4a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_SET_3D_CONTROL, 0x44);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_READ_MEMORY_CONTINUE,
				     0x44);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x3f, 0x46);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_SET_VSYNC_TIMING, 0x46);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x41, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x42, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x43, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x44, 0x41);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_GET_SCANLINE, 0x41);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x4a, 0x1e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x4b, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x4c, 0x1e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x4d, 0x1e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x4e, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x4f, 0x49);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x50, 0x49);
	mipi_dsi_dcs_set_display_brightness_multi(&dsi_ctx, 0x004b);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x52, 0x4b);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_WRITE_CONTROL_DISPLAY,
				     0x45);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x54, 0x45);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_WRITE_POWER_SAVE, 0x47);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x56, 0x47);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xaf, 0x20);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_READ_MEMORY_START,
				     0x44);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x41, 0xff);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xe0, 0x00);
...
{
	return drm_connector_helper_get_modes_fixed(connector, &jd9364_boe_mode);
}
...
static int jd9364_boe_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx = devm_drm_panel_alloc(dev, struct jd9364_boe, panel,
				   &jd9364_boe_panel_funcs,
