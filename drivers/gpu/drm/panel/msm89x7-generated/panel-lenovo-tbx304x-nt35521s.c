...
static int nt35521s_on(struct nt35521s *ctx)
{
	...
	mipi_dsi_generic_write_seq(dsi, 0xb6, 0x08);
	mipi_dsi_generic_write_seq(dsi, 0x6f, 0x02);
	mipi_dsi_generic_write_seq(dsi, 0xb8, 0x08);
	mipi_dsi_generic_write_seq(dsi, 0xbb, 0x54, 0x44);
	mipi_dsi_generic_write_seq(dsi, 0xbc, 0x05, 0x05);
	mipi_dsi_generic_write_seq(dsi, 0xc7, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xbd, 0x02, 0xb0, 0x1e, 0x1e, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xc5, 0x01, 0x07);
	mipi_dsi_generic_write_seq(dsi, 0xc8, 0x83);
	mipi_dsi_generic_write_seq(dsi, 0xf0, 0x55, 0xaa, 0x52, 0x08, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xb0, 0x05, 0x05);
	mipi_dsi_generic_write_seq(dsi, 0xb1, 0x05, 0x05);
	mipi_dsi_generic_write_seq(dsi, 0xbc, 0x90, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xbd, 0x90, 0x01);
	...
	mipi_dsi_generic_write_seq(dsi, 0xb4, 0x12, 0x12);
	mipi_dsi_generic_write_seq(dsi, 0xb9, 0x45, 0x45);
	mipi_dsi_generic_write_seq(dsi, 0xba, 0x14, 0x14);
	mipi_dsi_generic_write_seq(dsi, 0xf0, 0x55, 0xaa, 0x52, 0x08, 0x02);
	mipi_dsi_generic_write_seq(dsi, 0xee, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xef, 0x09, 0x06, 0x15, 0x18);
	mipi_dsi_generic_write_seq(dsi, 0xb0,
				   0x00, 0x00, 0x00, 0x0f, 0x00, 0x28);
	mipi_dsi_generic_write_seq(dsi, 0x6f, 0x06);
	mipi_dsi_generic_write_seq(dsi, 0xb0,
				   0x00, 0x47, 0x00, 0x58, 0x00, 0x76);
	mipi_dsi_generic_write_seq(dsi, 0x6f, 0x0c);
	mipi_dsi_generic_write_seq(dsi, 0xb0, 0x00, 0x9b, 0x00, 0xcd);
	...
	mipi_dsi_generic_write_seq(dsi, 0x6f, 0x0c);
	mipi_dsi_generic_write_seq(dsi, 0xb1, 0x02, 0x5f, 0x02, 0xbf);
	...
	mipi_dsi_generic_write_seq(dsi, 0x6f, 0x0c);
	mipi_dsi_generic_write_seq(dsi, 0xb2, 0x03, 0xbd, 0x03, 0xe4);
	mipi_dsi_generic_write_seq(dsi, 0xb3, 0x03, 0xf7, 0x03, 0xff);
	mipi_dsi_generic_write_seq(dsi, 0xf0, 0x55, 0xaa, 0x52, 0x08, 0x06);
	mipi_dsi_generic_write_seq(dsi, 0xb0, 0x0b, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xb1, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xb2, 0x2e, 0x09);
	mipi_dsi_generic_write_seq(dsi, 0xb3, 0x2a, 0x29);
	mipi_dsi_generic_write_seq(dsi, 0xb4, 0x1b, 0x19);
	mipi_dsi_generic_write_seq(dsi, 0xb5, 0x17, 0x15);
	mipi_dsi_generic_write_seq(dsi, 0xb6, 0x13, 0x11);
	mipi_dsi_generic_write_seq(dsi, 0xb7, 0x01, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xb8, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xb9, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xba, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xbb, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xbc, 0x2e, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xbd, 0x10, 0x12);
	mipi_dsi_generic_write_seq(dsi, 0xbe, 0x14, 0x16);
	mipi_dsi_generic_write_seq(dsi, 0xbf, 0x18, 0x1a);
	mipi_dsi_generic_write_seq(dsi, 0xc0, 0x29, 0x2a);
	mipi_dsi_generic_write_seq(dsi, 0xc1, 0x08, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xc2, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xc3, 0x2e, 0x0a);
	mipi_dsi_generic_write_seq(dsi, 0xe5, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xc4, 0x0a, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xc5, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xc6, 0x2e, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xc7, 0x2a, 0x29);
	mipi_dsi_generic_write_seq(dsi, 0xc8, 0x10, 0x12);
	mipi_dsi_generic_write_seq(dsi, 0xc9, 0x14, 0x16);
	mipi_dsi_generic_write_seq(dsi, 0xca, 0x18, 0x1a);
	mipi_dsi_generic_write_seq(dsi, 0xcb, 0x08, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xcc, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xcd, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xce, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xcf, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xd0, 0x2e, 0x09);
	mipi_dsi_generic_write_seq(dsi, 0xd1, 0x1b, 0x19);
	mipi_dsi_generic_write_seq(dsi, 0xd2, 0x17, 0x15);
	mipi_dsi_generic_write_seq(dsi, 0xd3, 0x13, 0x11);
	mipi_dsi_generic_write_seq(dsi, 0xd4, 0x29, 0x2a);
	mipi_dsi_generic_write_seq(dsi, 0xd5, 0x01, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xd6, 0x2e, 0x2e);
	mipi_dsi_generic_write_seq(dsi, 0xd7, 0x2e, 0x0b);
	mipi_dsi_generic_write_seq(dsi, 0xe6, 0x2e, 0x2e);
	...
	mipi_dsi_generic_write_seq(dsi, 0xb2, 0x05, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xb6, 0x05, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xb7, 0x05, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xba, 0x57, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xbb, 0x57, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xc0, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xc1, 0x00, 0x00, 0x00, 0x00);
	...
	mipi_dsi_generic_write_seq(dsi, 0xbd, 0x03, 0x01, 0x03, 0x03, 0x03);
	...
	mipi_dsi_generic_write_seq(dsi, 0xbb, 0x02);
	mipi_dsi_generic_write_seq(dsi, 0xbc, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xc0, 0x07);
	mipi_dsi_generic_write_seq(dsi, 0xc4, 0x80);
	mipi_dsi_generic_write_seq(dsi, 0xc5, 0xa4);
	mipi_dsi_generic_write_seq(dsi, 0xc8, 0x05, 0x30);
	mipi_dsi_generic_write_seq(dsi, 0xc9, 0x01, 0x31);
	mipi_dsi_generic_write_seq(dsi, 0xcc, 0x00, 0x00, 0x3c);
	mipi_dsi_generic_write_seq(dsi, 0xcd, 0x00, 0x00, 0x3c);
	mipi_dsi_generic_write_seq(dsi, 0xd1, 0x00, 0x05, 0x09, 0x07, 0x10);
	mipi_dsi_generic_write_seq(dsi, 0xd2, 0x00, 0x05, 0x0e, 0x07, 0x10);
