...
static int mdss_dsi_hx8394a_on(struct mdss_dsi_hx8394a *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xba,
			       0x13, 0x82, 0x00, 0x16, 0xc5, 0x00, 0x10, 0xff,
			       0x0f, 0x24, 0x03, 0x21, 0x24, 0x25, 0x20, 0x08);
	mipi_dsi_dcs_write_seq(dsi, );
	mipi_dsi_dcs_write_seq(dsi, 0xb1,
			       0x01, 0x00, 0x37, 0x87, 0x01, 0x11, 0x11, 0x22,
			       0x2a, 0x19, 0x3f, 0x57, 0x02, 0x00, 0xe6, 0xe2);
	usleep_range(10000, 11000);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x00, 0xc8, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0xc6, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0xbf, 0x06, 0x00, 0x10, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xb4,
			       0x80, 0x08, 0x32, 0x10, 0x0d, 0x32, 0x10, 0x08,
			       0x22, 0x10, 0x08, 0x37, 0x04, 0x4a, 0x11, 0x37,
			       0x04, 0x40, 0x06, 0x5a, 0x5a, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0xd5,
			       0x00, 0x00, 0x00, 0x10, 0x0a, 0x00, 0x01, 0x33,
			       0x00, 0x00, 0x33, 0x00, 0x23, 0x01, 0x67, 0x45,
			       0x01, 0x23, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88,
			       0x88, 0x88, 0x88, 0x88, 0x88, 0x45, 0x99, 0x88,
			       0x54, 0x76, 0x10, 0x32, 0x32, 0x10, 0x88, 0x88,
			       0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88,
			       0x88, 0x54, 0x88, 0x99);
	mipi_dsi_dcs_write_seq(dsi, 0xc7, 0x00, 0x10, 0x00, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0xe0,
			       0x00, 0x0a, 0x14, 0x39, 0x3e, 0x3f, 0x24, 0x44,
			       0x04, 0x0b, 0x0f, 0x13, 0x14, 0x14, 0x15, 0x18,
			       0x1c, 0x00, 0x0a, 0x14, 0x39, 0x3e, 0x3f, 0x24,
			       0x44, 0x04, 0x0b, 0x0f, 0x13, 0x16, 0x14, 0x15,
			       0x18, 0x1c, 0x08, 0x17, 0x0a, 0x1a, 0x08, 0x17,
			       0x0a, 0x1a);
	mipi_dsi_dcs_write_seq(dsi, 0xc0, 0x0c, 0x17);
	mipi_dsi_dcs_write_seq(dsi, 0xcc, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0xd4, 0x32);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x24);
				      ...
				      struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(connector->dev, &mdss_dsi_hx8394a_mode);
	if (!mode)
		return -ENOMEM;
...
static int mdss_dsi_hx8394a_probe(struct mipi_dsi_device *dsi)
{
	...
	drm_panel_init(&ctx->panel, dev, &mdss_dsi_hx8394a_panel_funcs,
